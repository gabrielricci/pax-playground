...
enum opt_code
{
  ...
  OPT_mandroid = 957,                        /* -mandroid */
  OPT_mapcs = 958,                           /* -mapcs */
  OPT_mapcs_float = 959,                     /* -mapcs-float */
  OPT_mapcs_frame = 960,                     /* -mapcs-frame */
  OPT_mapcs_reentrant = 961,                 /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 962,               /* -mapcs-stack-check */
  OPT_march_ = 963,                          /* -march= */
  OPT_marm = 964,                            /* -marm */
  OPT_mbig_endian = 965,                     /* -mbig-endian */
  ...
  OPT_mfpe_ = 976,                           /* -mfpe= */
  OPT_mfpu_ = 977,                           /* -mfpu= */
  OPT_mglibc = 978,                          /* -mglibc */
  OPT_mhard_float = 979,                     /* -mhard-float */
  OPT_mlittle_endian = 980,                  /* -mlittle-endian */
  OPT_mlong_calls = 981,                     /* -mlong-calls */
  OPT_mpic_register_ = 982,                  /* -mpic-register= */
  OPT_mpoke_function_name = 983,             /* -mpoke-function-name */
  OPT_msched_prolog = 984,                   /* -msched-prolog */
  ...
  OPT_mthumb_interwork = 989,                /* -mthumb-interwork */
  OPT_mtls_dialect_ = 990,                   /* -mtls-dialect= */
  OPT_mtp_ = 991,                            /* -mtp= */
  OPT_mtpcs_frame = 992,                     /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 993,                /* -mtpcs-leaf-frame */
  OPT_mtune_ = 994,                          /* -mtune= */
  OPT_muclibc = 995,                         /* -muclibc */
  OPT_munaligned_access = 996,               /* -munaligned-access */
  OPT_mvectorize_with_neon_quad = 997,       /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 998,               /* -mword-relocations */
  OPT_mwords_little_endian = 999,            /* -mwords-little-endian */
  OPT_n = 1000,                              /* -n */
  ...
  OPT_pie = 1015,                            /* -pie */
  OPT_pipe = 1016,                           /* -pipe */
  OPT_posix = 1017,                          /* -posix */
  OPT_print_file_name_ = 1018,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1019,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1020,          /* -print-multi-directory */
  OPT_print_multi_lib = 1021,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1022,       /* -print-multi-os-directory */
  OPT_print_objc_runtime_info = 1023,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1024,               /* -print-prog-name= */
  OPT_print_search_dirs = 1025,              /* -print-search-dirs */
  OPT_print_sysroot = 1026,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1027,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1028,                        /* -profile */
  OPT_pthread = 1029,                        /* -pthread */
  OPT_quiet = 1030,                          /* -quiet */
  OPT_r = 1031,                              /* -r */
  OPT_rdynamic = 1032,                       /* -rdynamic */
  OPT_remap = 1033,                          /* -remap */
  OPT_s = 1034,                              /* -s */
  OPT_s_bc_abi = 1035,                       /* -s-bc-abi */
  OPT_save_temps = 1036,                     /* -save-temps */
  OPT_save_temps_ = 1037,                    /* -save-temps= */
  OPT_shared = 1038,                         /* -shared */
  OPT_shared_libgcc = 1039,                  /* -shared-libgcc */
  /* OPT_specs = 1040, */                    /* -specs */
  OPT_specs_ = 1041,                         /* -specs= */
  OPT_static = 1042,                         /* -static */
  OPT_static_libgcc = 1043,                  /* -static-libgcc */
  OPT_static_libgcj = 1044,                  /* -static-libgcj */
  OPT_static_libgfortran = 1045,             /* -static-libgfortran */
  OPT_static_libgo = 1046,                   /* -static-libgo */
  OPT_static_libstdc__ = 1047,               /* -static-libstdc++ */
  /* OPT_std_c__03 = 1048, */                /* -std=c++03 */
  OPT_std_c__0x = 1049,                      /* -std=c++0x */
  OPT_std_c__98 = 1050,                      /* -std=c++98 */
  ...
  OPT_std_legacy = 1071,                     /* -std=legacy */
  OPT_symbolic = 1072,                       /* -symbolic */
  OPT_t = 1073,                              /* -t */
  OPT_time = 1074,                           /* -time */
  OPT_time_ = 1075,                          /* -time= */
  OPT_tno_android_cc = 1076,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1077,                 /* -tno-android-ld */
